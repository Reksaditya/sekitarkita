  ...
  return (
    <section className="flex flex-col items-center px-5 md:px-20 py-10 gap-10" id="contact">
      ...
      <form className="w-fit px-5 md:px-10 py-5 bg-white shadow-xl rounded-xl">
        <div className="flex flex-col md:flex-row w-full gap-3 pb-3 items-center justify-center lg:justify-start">
        ...
        <Button variant={"default"} className="font-semibold w-full">Kirim Form</Button>
      </form>
    </section>
  )
}